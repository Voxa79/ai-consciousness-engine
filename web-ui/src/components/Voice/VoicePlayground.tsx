...
const WS_URL = (process.env as any)?.REACT_APP_WS_URL || 'ws://localhost:3001/ws';
  ...
  return (
    <Box>
      ...
      <Typography variant="body2" color="text.secondary" gutterBottom>
        PoC temps réel (WS). Envoi de prompt texte → tokens en direct depuis votre gateway WebSocket → Ollama.
      </Typography>
